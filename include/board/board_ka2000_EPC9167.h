#ifndef INCLUDE_BOARD_ka2000_EPC9167_H_
#define INCLUDE_BOARD_ka2000_EPC9167_H_
...
#define APP_NODE_NAME "KA_EPC9167"
...
// VERSION
#ifdef ADC9_SUPPORT
#define ADC_SOC_9_CHANNEL_NUMBER ADC_SocChanNumber_B0
#endif
...
#define nUSER_IQ_FULL_SCALE_FREQ_Hz (800.3)    // 800 Example with buffer for 8-pole 6 KRPM motor to be run to 10 KRPM with field weakening; Hz =(RPM * Poles) / 120
...
#define nUSER_PWM_FREQ_kHz                    (35.0)    // 30.0 Example, 8.0 - 30.0 KHz typical; 45-80 KHz may be required for very low inductance, high speed motors
...
#endif /* INCLUDE_BOARD_ka2000_EPC9186_H_ */
