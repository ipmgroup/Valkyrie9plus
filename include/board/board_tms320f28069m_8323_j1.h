...
// The BOOSTXL-DRV8323RS board can be used, but it does not support TZ.
// to support TZ it is necessary to connect GPIO22 to GPIO13.
...
// #define PWMDACS
#define SPIA
#define SPI_CS GPIO_Number_51

#define ADC_SOC_TRIGGER_SOURCE   ADC_SocTrigSrc_EPWM1_ADCSOCA
#define ADC_SOC_0_CHANNEL_NUMBER ADC_SocChanNumber_B0
#define ADC_SOC_1_CHANNEL_NUMBER ADC_SocChanNumber_B0
#define ADC_SOC_2_CHANNEL_NUMBER ADC_SocChanNumber_A0
#define ADC_SOC_3_CHANNEL_NUMBER ADC_SocChanNumber_B2
#define ADC_SOC_4_CHANNEL_NUMBER ADC_SocChanNumber_A7
#define ADC_SOC_5_CHANNEL_NUMBER ADC_SocChanNumber_B1
#define ADC_SOC_6_CHANNEL_NUMBER ADC_SocChanNumber_A2
#define ADC_SOC_7_CHANNEL_NUMBER ADC_SocChanNumber_A6
...
#define DRV83XX_CONFIG(h, v)                           \
    do {                                               \
        ...
        v->Ctrl_Reg_06.CSA_GAIN   = dCSA_GAIN;         \
